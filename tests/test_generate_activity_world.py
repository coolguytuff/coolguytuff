...
class ActivityWorldTests(unittest.TestCase):
    ...
    def test_spring_physics_deforms_then_settles(self):
        a=render._spring_response(0,7,'feet'); b=render._spring_response(.18,7,'feet'); c=render._spring_response(1.2,7,'feet'); self.assertNotEqual(a,(0,1,1,0)); self.assertNotEqual(b,(0,1,1,0)); self.assertEqual(c,(0,1,1,0)); self.assertTrue(a[1]>1 or a[2]<1)
